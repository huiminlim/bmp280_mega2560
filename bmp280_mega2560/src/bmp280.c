...
int bmp280_init(void) {
    ...
    // Somehow it doesn't work now and if this is not done, the sampling of temperature is not done well
    // Run the Arduino IDE sketch to set the sampling data first in sensor, then run this value
